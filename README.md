...
版本号规则、目录规范与完整发版流程见 **[docs/版本管理.md](docs/版本管理.md)**；
两条命令各管一件事：

```bash
python scripts/version_manage.py status   # 版本号一致性（version.py / pyproject / CHANGELOG）
python scripts/release_flow.py status     # 已归档的发行包与旧版本查阅
```
